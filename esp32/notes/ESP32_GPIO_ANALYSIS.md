...
```
tools/esp32_img2elf.py esp32/firmware/ota_0.bin esp32/firmware/ota_0.elf
```
...
```bash
python3 tools/esp32_img2elf.py esp32/firmware/ota_0.bin esp32/firmware/ota_0.elf
```
...
# Section/header info
xtensa-esp32-elf-objdump -x esp32/firmware/ota_0.elf
```
