...
1. Dumped U13 flash (1 MB) → `u13/firmware/u13_flash_1mb.bin`.
...
6. Dumped RAM from live firmware (48 KB) → `u13/firmware/ram_full.bin`.
...
Dumped 48 KB RAM (`u13/firmware/ram_full.bin`, addresses `0x20000000–0x2000BFFF`).
...
| File | Description |
|------|-------------|
| `u13/firmware/u13_flash_1mb.bin` | Full U13 flash dump (1 MB) |
| `u13/firmware/ram_full.bin` | RAM dump `0x20000000–0x2000BFFF` (48 KB) |
| `u13/firmware/ram_low.bin` | Earlier RAM dump `0x20000000–0x20003FFF` (16 KB) |
| `u13/eeprom/eeprom_part.bin` | Verified EEPROM bytes 0x00–0x5F |
...
python3 <<'EOF'
import struct
data = open('u13/firmware/u13_flash_1mb.bin','rb').read()
for i in range(18):
    off = 0x85458 + i*12
